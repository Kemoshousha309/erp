 ...
 * @property {Object} excelPage - holds excel page information
 * @property {string} displayPattern decide the layout pattern of the screen 
 * - this property is handled at RenderDisplayPattern
 * - it can be "BASIC" OR "TREE" OR "SCREEN_PRIV" and more ...
 */
