...
class SystemCommands extends Component {
  ...
  render() {
    ...
    const commandsComponents = {
      ...
      GenUngenPriv: (
        <GenUngenPriv
          genUngenPrivExcuteHandler={genUngenPrivExecuteHandler}
...
// this function is related only to this component and would be unexpected in other components....
