export const costCenterPrivInitState = {
  fields: {
    from_bank_no: {
      ...
      controlField: true,
      value: '',
      fillFields: [{ recordName: 'bank_no', stateName: 'from_bank_no' }],
    },
    to_bank_no: {
      fieldType: 'input',
      type: 'number',
      ...
      controlField: true,
      value: '',
      fillFields: [{ recordName: 'bank_no', stateName: 'to_bank_no' }],
    },
    from_user_id: {
      fieldType: 'input',
      type: 'number',
  ...
  propsNames: ['user_id', 'bank_no', 'add_priv', 'view_priv'],
  // pks
  identifiers: ['user_id', 'bank_no'],
}