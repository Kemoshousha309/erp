...
// instructions
const ChartsExcelInstructions = ({ lanTable, lanState }) => {
  return (
    <div>
      <h3>{t("instruction_before_load_excel", lanTable, lanState)}</h3>
      <ul>
        <li>
          <span>{t("file_order", lanTable, lanState)} :</span>
          <br />
          {t("acc_no", lanTable, lanState)} ({t("number", lanTable, lanState)})
          -{t("currency", lanTable, lanState)} ({t("text", lanTable, lanState)}{" "}
          {t("with", lanTable, lanState)} , {t("dilimter", lanTable, lanState)})
          -{t("name", lanTable, lanState)} ({t("text", lanTable, lanState)}) -
          ...
          {t("number", lanTable, lanState)}) -{t("type", lanTable, lanState)} (
          {t("boolean", lanTable, lanState)}) -
          {t("report_type", lanTable, lanState)} (
          {t("boolean", lanTable, lanState)}) -{t("group", lanTable, lanState)}{" "}
          ({t("number", lanTable, lanState)}) -
          {t("acc_nature", lanTable, lanState)} (
          {t("boolean", lanTable, lanState)}) -
          {t("acc_type", lanTable, lanState)} ({t("number", lanTable, lanState)}
          ) -{t("acc_dtl", lanTable, lanState)} (
          {t("number", lanTable, lanState)})-
          {t("cash_flow_type", lanTable, lanState)} (
          {t("number", lanTable, lanState)}) -{t("cc_post", lanTable, lanState)}{" "}
          ({t("number", lanTable, lanState)}) -
